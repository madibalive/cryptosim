...
* @returns {string}
*/
module.exports.encrypt_message = function(pubkey_pem, msg) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        const ptr0 = passStringToWasm0(pubkey_pem, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
...
class Ballot {
    ...
    static __wrap(ptr) {
        const obj = Object.create(Ballot.prototype);
        obj.ptr = ptr;
    ...
    */
    static new(k) {
        const ret = wasm.ballot_new(k);
        return Ballot.__wrap(ret);
    }
    /**
    ...
    */
    get_pubkey_pem() {
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            wasm.ballot_get_pubkey_pem(retptr, this.ptr);
            var r0 = getInt32Memory0()[retptr / 4 + 0];
            var r1 = getInt32Memory0()[retptr / 4 + 1];
            return getStringFromWasm0(r0, r1);
        } finally {
    ...
    */
    vote(encrypted_vote) {
        const ptr0 = passStringToWasm0(encrypted_vote, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        wasm.ballot_vote(this.ptr, ptr0, len0);
    }
    /**
    ...
    */
    finalize() {
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            wasm.ballot_finalize(retptr, this.ptr);
            var r0 = getInt32Memory0()[retptr / 4 + 0];
            var r1 = getInt32Memory0()[retptr / 4 + 1];
            return getStringFromWasm0(r0, r1);
        } finally {
...
module.exports.__wbg_log_4eaf73963cb54bf5 = function(arg0, arg1) {
    try {
...
const path = require('path').join(__dirname, 'private_voting_bg.wasm');
