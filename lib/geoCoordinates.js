...
class GeoCoordinates {
   ...
   * @return {GeoCoordinates} a new object that with identical properties
   *          this object.
   */
  clone() {
   ...
   * @return {Object} a serialization of the geographical coordiantes.
   */
  serialize() {
    return {
  ...
  /**
   * Import coordiantes.
   * @param {String} blob - a serialization of the geographical coordiantes as
   *        exported by the serialize() function.
   * @return {GeoCoordinates} - a reconstructed GeoCoordinates object.
   */
  static deserialize(blob) {
    return new GeoCoordinates(blob.latitude, blob.longitude, blob.altitude);
  }
};
